...
正数的原码，反码，补码都是一样的，所以只需要第一位（符号位）填零，其他位补零就好了。而对于负数，原码第一位（符号位）为1，其他位补零，反码则是在原码的基础上，出第一位符号位不变，其他位按位取反，补码则是在反码的基础上加一。
...
![](/assets/img/posts/questions/Snipaste_2018-10-31_21-20-33.png)
